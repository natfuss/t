...
class Configuration(object):
    ...
    def initialize(cls, load_interface=True):
        ...
        cls.wordlist = None
        wordlists = [
            './wordlist.txt',  # Local file (ran from cloned repo)
            '/usr/share/dict/wordlist',  # setup.py with prefix=/usr
            '/usr/local/share/dict/wordlist',  # setup.py with prefix=/usr/local
